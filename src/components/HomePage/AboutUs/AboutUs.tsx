      ...
      <Container>
        <div className="bg-project-bg-gradient flex flex-col-reverse md:flex-row w-full h-fit rounded-2xl mt-[90px]  p-5 md:px-17">
          <div className="w-full md:w-[60%] flex flex-col justify-center items-center md:items-baseline gap-6">
            ...
            <div className="relative w-[300px] px-[39px] py-[17px] mt-1 text-lg text-neutral-10 font-Jost rounded-full font-medium flex flex-col justify-center items-center gap-1 bg-gradient-button ">
              <Image
